// File: Features/Assistant/LearnedProfileView.swift
//
// Transparency screen for the learning layer — shows exactly what the app has
// inferred about the traveler from their own activity, and lets them wipe it.
// Mirrors the trust-building intent of the app ("What the app remembers"),
...
struct LearnedProfileView: View {
    ...
    var body: some View {
        ...
        .confirmationDialog("Forget everything JetSetter has learned?",
            ...
            Text("This clears the inferred profile and its signals. Your trips, expenses, and saved preferences are not affected.")
        }
    }
    ...
    private var header: some View {
        VStack(alignment: .leading, spacing: 6) {
            Text("Inferred from your own activity")
                ...
                .foregroundStyle(JetsetterTheme.Colors.textPrimary)
            Text("JetSetter Pro builds this on your device from the seats you pick, flights you take, receipts you scan, and trips you complete. It's never shared.")
                .font(.subheadline)
    ...
    private var emptyState: some View {
        VStack(spacing: 14) {
            ...
            Text("Nothing learned yet")
                .font(.headline)
                .foregroundStyle(JetsetterTheme.Colors.textPrimary)
            Text("As you check in, scan receipts, and take trips, JetSetter Pro will start to recognize your preferences here.")
                .font(.subheadline)
                .foregroundStyle(JetsetterTheme.Colors.textSecondary)
    ...
    private var wipeButton: some View {
        Button(role: .destructive) {
            ...
            Label("Forget What JetSetter Learned", systemImage: "trash")
...
#Preview {
    NavigationStack { LearnedProfileView() }
}
