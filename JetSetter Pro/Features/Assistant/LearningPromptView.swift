// File: Features/Assistant/LearningPromptView.swift
//
...
struct LearningPromptView: View {
    ...
    var body: some View {
        VStack(spacing: 0) {
            ...
            Text("Let JetSetter Pro learn your travel style")
                .font(JetsetterTheme.Typography.pageTitle)
                .multilineTextAlignment(.center)
                .foregroundStyle(JetsetterTheme.Colors.textPrimary)
                .padding(.horizontal, 24)

            Text("With your permission, JetSetter Pro notices the seats you pick, the airlines you fly, the receipts you scan, and the places you go — to anticipate what you need and personalize every trip, entirely on this iPhone.")
                .font(.subheadline)
                .multilineTextAlignment(.center)
...
#Preview {
    LearningPromptView().environment(UserPreferences.shared)
}
